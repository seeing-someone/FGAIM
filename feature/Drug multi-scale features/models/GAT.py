    ...
    def __init__(self,
        ...
        if num_layers == 1:
            self.gat_layers.append(GATConv(
                ...
                feat_drop, attn_drop, negative_slope, last_residual, allow_zero_in_degree=True, norm=last_norm, concat_out=concat_out))
        else:
            # input projection (no residual)
            self.gat_layers.append(GATConv(
                in_dim, num_hidden, nhead,
                feat_drop, attn_drop, negative_slope, residual, create_activation(activation), allow_zero_in_degree=True, norm=norm, concat_out=concat_out))
            # hidden layers
            ...
            self.gat_layers.append(GATConv(
                ...
                feat_drop, attn_drop, negative_slope, last_residual, allow_zero_in_degree=True, activation=last_activation, norm=last_norm, concat_out=concat_out))
